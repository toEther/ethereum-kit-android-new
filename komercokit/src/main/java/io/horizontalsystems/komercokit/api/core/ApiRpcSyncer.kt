...
import io.horizontalsystems.komercokit.api.jsonrpc.BlockNumberJsonRpc
import io.horizontalsystems.komercokit.api.jsonrpc.JsonRpc
import io.horizontalsystems.komercokit.core.KomercoKit
import io.horizontalsystems.komercokit.network.ConnectionManager
...
class ApiRpcSyncer(
    ...
    private fun handleConnectionChange() {
        ...
        if (connectionManager.isConnected) {
            ...
            state = SyncerState.NotReady(KomercoKit.SyncError.NoNetworkConnection())
            stopTimer()
        }
    }
