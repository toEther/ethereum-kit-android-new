package io.horizontalsystems.komercokit.api.core

import com.google.gson.Gson
import io.horizontalsystems.komercokit.api.jsonrpc.JsonRpc
import io.horizontalsystems.komercokit.api.jsonrpc.SubscribeJsonRpc
import io.horizontalsystems.komercokit.api.jsonrpcsubscription.NewHeadsRpcSubscription
import io.horizontalsystems.komercokit.api.jsonrpcsubscription.RpcSubscription
...
class WebSocketRpcSyncer(
    ...
    override var state: SyncerState = SyncerState.NotReady(KomercoKit.SyncError.NotStarted())
        private set(value) {
            if (value != field) {
                field = value
    ...
    override fun stop() {
        state = SyncerState.NotReady(KomercoKit.SyncError.NotStarted())
