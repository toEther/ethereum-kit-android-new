...
open class Erc20BaseAdapter(
    ...
    protected val erc20Kit = Erc20Kit.getInstance(context, komercoKit, contractAddress)
    ...
    override val syncState: SyncState
        get() = convertToKomercoKitSyncState(erc20Kit.syncState)

    override val transactionsSyncState: SyncState
        get() = convertToKomercoKitSyncState(erc20Kit.transactionsSyncState)
    ...
    override fun estimatedGasLimit(
        ...
        return komercoKit.estimateGas(transactionData, gasPrice)
    }
    ...
    private fun convertToKomercoKitSyncState(syncState: SyncState): SyncState {
