...
import io.horizontalsystems.komercokit.sample.modules.main.MainViewModel
...
class UniswapV3Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                UniswapV3Screen(
                    mainViewModel.komercoKit,
                    mainViewModel.erc20Adapter,
                    mainViewModel.komercoAdapter,
...
fun UniswapV3Screen(
    ...
    MaterialTheme {
        Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
            ...
            AmountInput(
                title = "Amount In (${viewModel.fromToken?.code ?: "KMC"})",
                initial = amountIn
            ) {
            ...
            Spacer(modifier = Modifier.height(12.dp))
            AmountInput(
                title = "Amount Out (${viewModel.toToken?.code ?: "KMC"})",
                initial = amountOut
            ) {
