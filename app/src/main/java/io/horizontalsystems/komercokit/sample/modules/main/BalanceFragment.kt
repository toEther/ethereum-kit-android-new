...
import io.horizontalsystems.komercokit.sample.R
...
class BalanceFragment : Fragment() {
    ...
    private fun getSynStateInfo(syncState: KomercoKit.SyncState): SyncStateInfo =
            when (syncState) {
                is KomercoKit.SyncState.Synced -> SyncStateInfo("Synced")
                is KomercoKit.SyncState.Syncing -> SyncStateInfo("Syncing ${syncState.progress ?: ""}")
                is KomercoKit.SyncState.NotSynced -> SyncStateInfo("NotSynced", syncState.error)
            }
